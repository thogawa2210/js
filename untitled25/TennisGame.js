...
var TennisGame = /** @class */ (function () {
    ...
    TennisGame.prototype.getScore = function (player1Name, player2Name, m_score1, m_score2) {
        var equalScore = m_score1 == m_score2;
        if (equalScore) {
            switch (m_score1) {
                case 0:
                    this.score = "Love-All";
    ...
    TennisGame.prototype.compareInGame = function (m_score1, m_score2) {
        var tempScore;
        for (var i = 1; i < 3; i++) {
            if (i == 1)
                tempScore = m_score1;
    ...
    TennisGame.prototype.compareForLongGame = function (m_score1, m_score2) {
